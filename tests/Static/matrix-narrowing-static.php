 ...
 *
 * This file is analysed by PHPStan at level 8. It exercises the `Matrix`
 ...
 * `vendor/bin/phpstan analyse tests/Static/matrix-narrowing-static.php` —
...
$google = new Matrix(LocationProviderId::Google, new GoogleConfig(apiKey: 'k'));
$mapbox = new Matrix(LocationProviderId::Mapbox, new MapboxConfig(accessToken: 't'));
$here = new Matrix(LocationProviderId::Here, new HereConfig(apiKey: 'k'));
$esri = new Matrix(LocationProviderId::Esri, new EsriConfig(apiKey: 'k'));
$osrm = new Matrix(LocationProviderId::Osrm, new OsrmConfig(baseUrl: 'https://router.project-osrm.org'));
$tomtom = new Matrix(LocationProviderId::TomTom, new TomTomConfig(apiKey: 'k'));
 ...
 *
 * $bad = new Matrix(LocationProviderId::Google, new MapboxConfig(accessToken: 't'));
 * unset($bad);
 */
