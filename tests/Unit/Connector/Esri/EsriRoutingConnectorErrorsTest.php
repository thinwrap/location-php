...
/**
 * Error-mapping coverage for the Esri Routing connector.
 */
final class EsriRoutingConnectorErrorsTest extends TestCase
{
    private function connector(int $status, string $body): EsriRoutingConnector
    {
        ...
        return new EsriRoutingConnector(new EsriConfig(apiKey: 'k'), $client, $factory, $factory);
    }

    private function call(EsriRoutingConnector $c): void
    {
        $c->route(new RoutingOptions(waypoints: [new LatLng(32.08, 34.78), new LatLng(32.10, 34.80)]));
    }
