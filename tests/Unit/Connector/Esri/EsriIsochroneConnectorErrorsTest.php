...
/**
 * Error-mapping coverage for the Esri Isochrone connector.
 */
final class EsriIsochroneConnectorErrorsTest extends TestCase
{
    private function connector(int $status, string $body): EsriIsochroneConnector
    {
        ...
        return new EsriIsochroneConnector(new EsriConfig(apiKey: 'k'), $client, $factory, $factory);
    }

    private function call(EsriIsochroneConnector $c): void
    {
        $c->isochrone(new IsochroneOptions(
